...
@implementation NSData (BWTBase64)
...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
    ...
    size_t outputLength;
    void *outputBuffer = BWTNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
    ...
    char *outputBuffer =
        BWTNewBase64Encode([self bytes], [self length], false, &outputLength);
